...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/Article/selectDustbinPage.action" method=get>	
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：文章管理 &gt; 回收站</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
										...
										<TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
											<TBODY>
												...
												<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													...
													<TD>
													<a href="${pageContext.request.contextPath }/Article/compDelete.action?dustId=${dustbin.dustId}">彻底删除</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/Article/toDustEdit?dustId=${dustbin.dustId}">重新编辑</a>
													</TD>
												</TR>	
												</c:forEach>
											...
											<TBODY>
												<TR>
													<TD>当前页面：${currentPage}/${totalDustbins}</TD>
													<TD>选择页码：&nbsp;&nbsp;<INPUT class=textbox id=sChannel2 style="WIDTH: 80px" maxLength=50 name="toPage">
													&nbsp;&nbsp;<INPUT class=button id=sButton2 type=submit value=" 选择" name=sButton2></TD>
													<TD><a href="${pageContext.request.contextPath }/Article/preDustbin.action?currentPage=${currentPage}">上一页</a>
														<a href="${pageContext.request.contextPath }/Article/nextDustbin.action?currentPage=${currentPage}">下一页</a></TD>
													<TD><a href="${pageContext.request.contextPath }/Article/delePage.action?currentPage=${currentPage}">清空该页</a></TD>
												</TR>
