		...
		<DIV id=UpdatePanel1>
			...
			<DIV>
				<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
	  				<TBODY>
					  	<TR>
					    	<TD style="HEIGHT: 105px"><IMG src="${pageContext.request.contextPath}/img/login_1.gif"  border=0></TD>
					    </TR>
					  	<TR>
    						<TD background="${pageContext.request.contextPath}/img/login_2.jpg" height=300>
		              								...
		              								<TBODY>
										              	<TR>
										                	...
										                	<TD style="HEIGHT: 28px" width=150>
										                		<INPUT id=txtName style="WIDTH: 130px" name=txtName></TD>
										              	...
										              	<TR>
                											<TD></TD>
                											<TD>
                												<INPUT id=btn style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" onclick='javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("btn", "", true, "", "", false, false))'  type=image src="${pageContext.request.contextPath}/img/login_button.gif" name=btn> 
              												</TD>
              											</TR>
              										</TBODY>
              									</TABLE>
  						...
  						<TR>
    						<TD><IMG src="${pageContext.request.contextPath}/img/login_3.jpg" border=0></TD>
    					</TR>
    				</TBODY>
    			</TABLE>
    		</DIV>
