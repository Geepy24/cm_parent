...
<BODY>
	<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/Resource/selectPcPage.action" method=get>	
								...
								<TR>
									<TD>
										<TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
											...
											<TBODY>
												<TR>
													<TD>当前页面：${currentPage }/${totalPcs}</TD>
													<TD>选择页码</TD>
													...
													<TD><a href="${pageContext.request.contextPath }/Resource/prePcPage.action?currentPage=${currentPage}">上一页</a></TD>
													<TD><a href="${pageContext.request.contextPath }/Resource/nextPcPage.action?currentPage=${currentPage}">下一页</a></TD>
												</TR>
